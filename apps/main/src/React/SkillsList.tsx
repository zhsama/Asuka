...
const CategoryIcons = {
  ...
  "UI/UX Design & Prototyping": (
    <svg
      ...
      fill="currentColor"
      className="w-6 h-6 text-[var(--sec)] opacity-70"
      aria-label="UI/UX Design & Prototyping"
    >
      <title>UI/UX Design & Prototyping</title>
        ...
        {Object.entries(skills).map(([category, items]) => (
          <li key={category} className="w-full">
            <button
              ...
              className={`md:w-[400px] w-full bg-[#1414149c] rounded-2xl text-left hover:bg-opacity-80 transition-all cursor-pointer overflow-hidden ${
                openItem === category 
                  ? "border-2 border-[var(--primary)] shadow-[0_0_20px_rgba(252,238,9,0.4)]" 
                  : "border border-[var(--primary)] border-opacity-40"
              }`}
            >
